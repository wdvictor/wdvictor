...
![Visitors](https://komarev.com/ghpvc/?username=wdvictor&color=7C3AED&style=for-the-badge&label=PROFILE+VIEWS)
...
class VictorHugo:
    def __init__(self):
        ...
        self.stack       = {
            "backend"  : ["FastAPI", "GraphQL", "Python"],
            "frontend" : ["Angular", "TypeScript"],
            "mobile"   : ["Flutter", "Kotlin", "Swift"],
            "data"     : ["Machine Learning", "AI", "Semantic Search"],
            "infra"    : ["GCP", "Docker", "Linux", "PostgreSQL", "Oracle"],
        }
